...
const result = await build({entryPoints:['main.js'],define:{__QA__:String(qa),__DEV__:String(!desktop),__GM__:String(gm)},bundle:true,minify:true,format:'iife',write:false,legalComments:'inline',loader:{'.mp3':'dataurl'}});
