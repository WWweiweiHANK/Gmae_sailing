...
- 生成参考图当轮未修改运行时模型。2026-09-20 后续用户授权开始建模并替换饰品，已据此实施第一轮低多边形模型重建；实际截图见 `../../qa/remodel-hero.png`、`../../qa/remodel-side.png`、`../../qa/remodel-top.png`。此图仍保留为原始候选参考，不重命名为 MASTER。
